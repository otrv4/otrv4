...
k_dh:
  ...
  // TODO: this only states that is generated by a DH exchange. It does not
  state that this means the exponentiation. State so?
...
K_ecdh:
  ...
  as a POINT.
  // TODO: this only states that is generated by a ECDH exchange. It does not
  state that this means a point * scalar mul. State so?
...
To rotate the ECDH keys:
  ...
  * Calculate `K_ecdh = ECDH(our_ecdh.secret, their_ecdh)`. // TODO: what is
    ECDH function? Is this a ECDH exchange?
...
To rotate the mix key:
  ...
  * If `i % 3 == 0`:
    ...
    * Calculate `k_dh = DH(our_dh.secret, their_dh.public)`. // TODO: what is
      DH function? Is this a DH exchange?
...
// TODO: same todos as prev section apply here
...
// TODO: not actually generated only by scalar * point.
