...
k_dh:
      The serialized 3072-DH shared secret computed from a DH exchange = A^b, B^a.
...
K_ecdh:
      The serialized ECDH shared secret computed from an
      ECDH exchange = X*y, Y*x
```
...
(TODO: why alice not verifying this? Because it's not in the paper - ROM DAKE)
