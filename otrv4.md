...
k_dh:
      The serialized 3072-DH shared secret computed from a DH exchange = A^b, B^a. // TODO: should this be placed here?
...
K_ecdh:
      The serialized ECDH shared secret computed from an ECDH exchange = X*y, Y*x
```
