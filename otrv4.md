...
k_dh:
      The serialized 3072-bit DH shared secret computed from a DH exchange = A^b, B^a //TODO: find a way to serialize this big number
mix_key:
...
K_ecdh:
      The serialized 448-bit ECDH shared secret computed from an ECDH exchange = X*y, Y*x
```
